...
public class CLR1Parser {
    ...
    static String table[][]=
            {
                    ...
                    {"s5","s6",null,"7",null},
                    {"s3","s4",null,"8",null},
                    {"r3","r3",null,null,null},
                    {"s5","s6",null,"9",null},
                    {null,null,"r3",null,null},
                    {null,null,"r1",null,null},
                    {"r2","r2",null,null,null},
                    {null,null,"r2",null,null},
            };
    ...
    public static void disp(String s,int p)
    {
        int t;
        for(t=p;t<s.length();t++)
        {
